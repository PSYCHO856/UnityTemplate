...
internal static class MessengerInternal
{
    ...
    public static MessengerMode DEFAULT_MODE = MessengerMode.DONT_REQUIRE_LISTENER;
...
public static class Messenger<T>
{
    ...
    public static void Broadcast<TReturn>(string eventType, T arg1, Action<TReturn> returnCall, MessengerMode mode)
    {
        ...
        foreach (var result in invocationList.Select(del => del.Invoke(arg1))) returnCall.Invoke(result);
    }
}
...
public static class Messenger<T, U>
{
        ...
        MessengerMode mode)
    {
        ...
        foreach (var result in invocationList.Select(del => del.Invoke(arg1, arg2))) returnCall.Invoke(result);
    }
}
...
public static class Messenger<T, U, V>
{
        ...
        MessengerMode mode)
    {
        ...
        foreach (var result in invocationList.Select(del => del.Invoke(arg1, arg2, arg3))) returnCall.Invoke(result);
    }
}