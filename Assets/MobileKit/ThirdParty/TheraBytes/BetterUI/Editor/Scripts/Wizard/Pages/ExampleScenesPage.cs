...
namespace TheraBytes.BetterUi.Editor
{
    public class ExampleScenesPage : WizardPage
    {
        ...
        const string OVERVIEW_PACK = "MobileKit/ThirdParty/TheraBytes/BetterUI/packages/Example_Overiew.unitypackage";
        ...
        {
            string package = Path.Combine(Application.dataPath, string.Format("MobileKit/ThirdParty/TheraBytes/BetterUI/packages/Example_{0}.unitypackage", exampleName));
            string folder = Path.Combine(Application.dataPath, string.Format("MobileKit/ThirdParty/TheraBytes/BetterUI/Example/{0}", exampleName));
