...
namespace TheraBytes.BetterUi.Editor
{
    public class AssemblyDefinitionsPage : WizardPage
    {
        static readonly string[] ASMDEF_FILES =
            { 
                "MobileKit/ThirdParty/TheraBytes/BetterUI/Runtime/TheraBytes.BetterUi.Runtime.asmdef",
                "MobileKit/ThirdParty/TheraBytes/BetterUI/Editor/TheraBytes.BetterUi.Editor.asmdef",
        ...
        const string PACKAGE_PATH_INCL_TMP = "MobileKit/ThirdParty/TheraBytes/BetterUI/packages/asmdef_incl_TextMeshPro.unitypackage";
        const string PACKAGE_PATH_EXCL_TMP = "MobileKit/ThirdParty/TheraBytes/BetterUI/packages/asmdef_excl_TextMeshPro.unitypackage";
