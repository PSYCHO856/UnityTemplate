...
namespace TheraBytes.BetterUi.Editor
{
    ...
    {
        const string PACKAGE_PATH_TMP_OLD = "MobileKit/ThirdParty/TheraBytes/BetterUI/packages/BetterUI_TextMeshPro_UiEditorPanel.unitypackage";
        const string PACKAGE_PATH_TMP_NEW = "MobileKit/ThirdParty/TheraBytes/BetterUI/packages/BetterUI_TextMeshPro_EditorPanelUI.unitypackage";
