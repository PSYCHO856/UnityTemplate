...
namespace Malee.List {
	...
	public class ReorderableList {
		...
		public delegate void DrawElementDelegate(Rect rect, SerializedProperty element, int index, GUIContent label, bool selected, bool focused);
		...
		*/
		...
		private void DrawElement(SerializedProperty element, Rect rect, int index, bool selected, bool focused) {
			...
			if (drawElementBackgroundCallback != null) {
				...
				drawElementBackgroundCallback(backgroundRect, element, index, null, selected, focused);
			}
			else if (evt.type == EventType.Repaint) {
			...
			if (drawElementCallback != null) {
				...
				drawElementCallback(renderRect, element, index, label, selected, focused);
			}
			else {
