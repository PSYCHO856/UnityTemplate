...
namespace MobileKit
{
    public abstract class TweenCase
    {
        ...
        public TweenManager.TweenCallback onCompleteCallback;
        ...
        {
            TweenManager.AddTween(this, tweenType);
        ...
        public TweenCase OnComplete(TweenManager.TweenCallback callback)
        {
    ...
    {
        private TweenManager.TweenCallback callback;
        protected int resultFrame;
        protected int framesOffset;

        public TweenCaseNextFrame(TweenManager.TweenCallback callback, int framesOffset)
        {
    ...
    {
        public TweenCaseUpdateNextFrame(TweenManager.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        {
            resultFrame = TweenManager.UpdateFramesCount + framesOffset;
        ...
        {
            return resultFrame <= TweenManager.UpdateFramesCount;
        }
    }

    public class TweenCaseFixedUpdateNextFrame : TweenCaseNextFrame
    {
        public TweenCaseFixedUpdateNextFrame(TweenManager.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        public override TweenCase StartTween()
        {
            resultFrame = TweenManager.FixedUpdateFramesCount + framesOffset;
        ...
        public override bool CheckFrameState()
        {
            return resultFrame <= TweenManager.FixedUpdateFramesCount;
        }
    }

    public class TweenCaseLateUpdateNextFrame : TweenCaseNextFrame
    {
        public TweenCaseLateUpdateNextFrame(TweenManager.TweenCallback callback, int framesOffset) : base(callback, framesOffset)
        {
        ...
        public override TweenCase StartTween()
        {
            resultFrame = TweenManager.LateUpdateFramesCount + framesOffset;
        ...
        public override bool CheckFrameState()
        {
            return resultFrame <= TweenManager.LateUpdateFramesCount;
        }
    }
