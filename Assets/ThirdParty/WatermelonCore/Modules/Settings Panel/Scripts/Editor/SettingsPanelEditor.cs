...
namespace Watermelon
{
    ...
    public class SettingsPanelEditor : WatermelonEditor
    {
        ...
        {
            var item = settingsPanel.SettingsButtonsInfo[index];

            EditorGUI.BeginChangeCheck();
            item.SettingsButton = (SettingsButtonBase) EditorGUI.ObjectField(
                new Rect(rect.x + 18, rect.y, rect.width - 18, 20), item.SettingsButton, typeof(SettingsButtonBase),
                true);
        ...
        public override void OnInspectorGUI()
        {
            ...
            var tempObject = settingsAnimationProperty.objectReferenceValue;
            ...
            if (tempObject != settingsAnimationProperty.objectReferenceValue)
                if (settingsAnimationProperty.objectReferenceValue != null)
                    ...
                    {
                        var settingsAnimation = (SettingsAnimation) settingsAnimationProperty.objectReferenceValue;
