...
namespace Watermelon
{
    public class AdsManagerExampleScript : MonoBehaviour
    {
        ...
        [Space] [SerializeField] private Text bannerTitleText;

        [SerializeField] private Button[] bannerButtons;

        [Space] [SerializeField] private Text interstitialTitleText;

        [SerializeField] private Button[] interstitialButtons;

        [Space] [SerializeField] private Text rewardVideoTitleText;
        ...
        {
            Log("[AdsManager]: Interstitial " + (AdsManager.IsInterstitialLoaded(settings.interstitialType)
                ? "is loaded"
                : "isn't loaded"));
        }
        ...
        {
            Log("[AdsManager]: Rewarded video " + (AdsManager.IsRewardBasedVideoLoaded(settings.rewardedVideoType)
                ? "is loaded"
                : "isn't loaded"));
        }
