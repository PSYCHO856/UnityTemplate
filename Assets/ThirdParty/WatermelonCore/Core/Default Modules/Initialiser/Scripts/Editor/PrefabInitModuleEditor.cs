...
namespace Watermelon
{
    ...
    public class PrefabInitModuleEditor : InitModuleEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var initObjectsArraySize = initPrefabsProperty.arraySize;
            if (initObjectsArraySize > 0)
                for (var i = 0; i < initObjectsArraySize; i++)
                {
                    var arrayElement = initPrefabsProperty.GetArrayElementAtIndex(i);
                    ...
                    if (GUILayout.Button("X", EditorStylesExtended.button_04_mini, GUILayout.Height(18),
                        ...
                        if (EditorUtility.DisplayDialog("Remove element",
                            "Are you sure you want to remove prefab object?", "Remove", "Cancel"))
                        {
        ...
        public override void Buttons()
        {
            if (GUILayout.Button("Add", GUILayout.Width(90)))
            {
                ...
                var arraySize = initPrefabsProperty.arraySize;
