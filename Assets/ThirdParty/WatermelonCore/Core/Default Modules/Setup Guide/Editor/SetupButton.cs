    ...
    public abstract class SetupButton
    {
        ...
        public virtual void Init()
        {
            content = new GUIContent(title,
                EditorStylesExtended.GetTexture(textureName, EditorStylesExtended.IconColor));
        }

        public void Draw(GUIStyle style)
        {
            if (GUILayout.Button(content, style, GUILayout.Height(50), GUILayout.ExpandWidth(true))) OnClick();
        }
