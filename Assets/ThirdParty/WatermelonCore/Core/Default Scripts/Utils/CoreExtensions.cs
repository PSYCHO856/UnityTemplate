...
namespace Watermelon
{
    public static class CoreExtensions
    {
        ...
        {
#if UNITY_EDITOR
            if (count >= array.Length) Debug.LogError("Array is to small!");
        ...
        {
#if UNITY_EDITOR
            if (count >= array.Count) Debug.LogError("Array is to small!");
        ...
        {
            for (var i = 0; i < array.Length; i++) Debug.Log(function(array[i]));
        }
        ...
        {
            for (var i = 0; i < array.Count; i++) Debug.Log(function(array[i]));
        }
